...
public class ReportActivity extends Activity {
	...
	public void createFingernailChart() {
		...
		graphView.setHorizontalLabels(new String[] {"4/11", "4/12", "4/13", "4/14"});
	...
	public void createFavoriteFoodChart() {
		layout.removeAllViews();
		GraphViewSeries FFSeries = new GraphViewSeries(new GraphView.GraphViewData[] {
				  new GraphViewData(1, 4d)
			    , new GraphViewData(2, 7d)
			    , new GraphViewData(3, 11d)
			    , new GraphViewData(4, 22d)
			});
		GraphView graphView = new LineGraphView(this, "");
		graphView.addSeries(FFSeries); // data
		graphView.setHorizontalLabels(new String[] {"xxx", "xxx", "xxx", "xxx"});
		graphView.getGraphViewStyle().setGridColor(Color.BLACK);
		graphView.getGraphViewStyle().setHorizontalLabelsColor(Color.RED);
		graphView.getGraphViewStyle().setVerticalLabelsColor(Color.RED);
		graphView.getGraphViewStyle().setNumHorizontalLabels(4 );
	...
	public void createFingernailAndWeightChart() {
		layout.removeAllViews();
		GraphViewSeries FSeries = new GraphViewSeries("甲長", new GraphViewSeriesStyle(Color.MAGENTA, 1), FData);
		GraphViewSeries WSeries = new GraphViewSeries("體重", new GraphViewSeriesStyle(Color.BLUE, 1), WData);
		GraphView graphView = new LineGraphView(this, "");
		graphView.addSeries(FSeries); // data
	...
	public void createNutritionChart() {
		layout.removeAllViews();
		GraphViewSeries NSeries = new GraphViewSeries(new GraphView.GraphViewData[] {
				  new GraphViewData(1, 80d)
			    , new GraphViewData(2, 57d)
			    , new GraphViewData(3, 100d)
